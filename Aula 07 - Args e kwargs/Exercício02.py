...
def criar_dicionario(quantidade, **kwargs): # Dentro dessa função, kwargs é considerado dicionário
    for i in range(quantidade):
        ...
        print("\nDicionário final:")
    return entradas # Kwargs será um dicionário com os argumentos passados
...
# Passando o dicionário como 'argumentos nomeados' usando **
print(criar_dicionario(quantidade, **entradas))
